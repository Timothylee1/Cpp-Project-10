...
// Brief Description: 
// This file contains the unit tests Point ADT.
// To test your operator>>, redirect contents of text file input.txt
// to standard input stream.
// To test your implementation, redirect output of unit tests to
// text file your-output.txt.
// Compare your-output.txt with my output.txt using diff. 

#include <iostream> // std::cin, std::cout, "\n"
#include <array>
#include "point.hpp"  // Point class

// unit tests for ctors and operator overloads
namespace {
...
void RotateTest() {
  ...
  std::cout << "Point " << pt1 << " rotated " << angle << " degrees is " << pt2 << "\n";

  hlp2::Point const pt3 = hlp2::Point(-6, -6);
  angle = -60.0;

  hlp2::Point const pt4 = pt3 % angle;
  std::cout << "Point " << pt3 << " rotated " << angle << " degrees is " << pt4 << "\n";

  angle = 0.0;
  std::cout << "Point " << pt1 << " rotated " << angle << " degrees is " << (pt1%angle) << "\n";
